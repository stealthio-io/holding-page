        ...
        <Grid container spacing={2} sx={{}}>
          ...
          <Grid item xs={9}>
            <Typography
              ...
              textAlign="left"
            >
              Build deeper relationships. Be faster, more efficient and
              engaging, <br /> with fully-immersive candidate experiences. and
              be more effective.
            </Typography>
          </Grid>
          ...
          >
            ...
            secretiveness, usually undertaken to avoid alerting competitors to a
            pending product launch, in a highly competitive software market.
          </Typography> */}
          ...
          <Grid
            ...
            sx={{
              ...
              backgroundSize: "100%",
              backgroundImage: "url(/Stelthio_space.png)",
            }}
          >
            <Typography
              sx={{
